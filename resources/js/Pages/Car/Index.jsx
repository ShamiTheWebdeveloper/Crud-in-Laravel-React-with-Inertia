    ...
    const columns = [
        ...
        },
        {
            ...
            selector: row =>(<div className='d-flex pt-2'>
                ...
                {'\u00A0'}
                {'\u00A0'}
                {/*<button type='button' onClick={deleteCar(row)} className='focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900'>Delete</button>*/}
            </div>),
        }
    ];
        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <DataTable columns={columns} data={cars} className='shadow'  pagination={true} selectableRows={true} expandableRows={true}  fixedHeader={true}/>
